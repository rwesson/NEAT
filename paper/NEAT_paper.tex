...
The new code, NEAT, largely builds upon previous codes, most importantly the {\sc equib} code (ref) for solving the equations of statistical equilibrium in multi-level atoms.  It requires as input a plain text list of rest wavelengths, line fluxes, and uncertainties.
