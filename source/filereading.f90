...
subroutine read_text_linelist(linelist,listlength,ncols,runs)
        implicit none
...
!debugging
#ifdef CO
        print *,"subroutine: read_text_linelist"
#endif
...
end subroutine read_text_linelist

subroutine read_fits_linelist(linelist,listlength,ncols)
! read a FITS file generated by ALFA or a previous NEAT analysis
! extension LINES contains rest wavelength, observed wavelength, flux, uncertainty, (peak, FWHM if generated by ALFA), transition data
  implicit none
  type(line), dimension(:), allocatable :: linelist
  logical, dimension(:), allocatable :: blends
  integer :: listlength, ncols, i
