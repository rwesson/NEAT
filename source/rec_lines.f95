...
! RW May 2009
     ...
     & F7.4, 1X, F7.4, 1X, F7.4)!, 1X, E10.4, 1X, E10.4, 1X)
            OPEN(201, file="/etc/neat/Roii.dat", status='old')
            read(201,*) nlines
...
oii_A_3p2S_low => oii_coefficients(36,:)
     ...
     &1X, A1, 1X, A9, 1X, F13.4, 1X, A1, A1, 1X, I2, 1X, A1, 1X, A9, 1X,&
     & F7.4, 1X, F7.4, 1X, F7.4)!, 1X, E10.4, 1X, E10.4, 1X)
            OPEN(201, file="/etc/neat/Rnii.dat", status='old')
            read(201,*) nlines
...
! read in CII data
      ...
      OPEN(201, file="/etc/neat/Rcii.dat", status='old')
      read(201,*) nlines
      ...
      OPEN(201, file="/etc/neat/Rneii.dat", status='old')
      read(201,*) nlines
      ...
      OPEN(201, file="/etc/neat/Rxiii.dat", status='old')
      read(201,*) nlines
