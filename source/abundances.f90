...
! get te and ne from OII RL diagnostics if we have them
        ...
        if (oii4089.gt.0 .and. oii4649.gt.0 .and. oii4662.gt.0) then
          ...
          iteration_result%oii_rl_R1=oii4649/oii4089
          iteration_result%oii_rl_R2=oii4649/oii4662
        else
...
! simple checks for the reliability of the abundance: flagged as unreliable if any of the following apply:
!  - only one multiplet detected
