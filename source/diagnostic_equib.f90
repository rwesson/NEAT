...
!        print *,"inputs: ion, upper level, lower level&
!                 &, ratio, T or D, fixed quantity"
!        stop
!      endif

!      call get_command_argument(1,ion)
!      call get_command_argument(2,levelu)
!      call get_command_argument(3,levell)
...
!      WRITE(6,1001) 
     ...
     & NAME='atomic_data06/'//ION(1:IONL)//'.dat')               
